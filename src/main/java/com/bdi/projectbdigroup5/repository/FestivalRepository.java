...
public interface FestivalRepository extends CrudRepository<Festival, Long>, PagingAndSortingRepository<Festival, Long> {
    ...
    public Page<Festival> findAllByDateDebutAndCommuneCodeInseeAndSousDomaineNom(
            Date dateDebut, String commune_codeInsee, String sousDomaine_nom, Pageable pageable);
}
